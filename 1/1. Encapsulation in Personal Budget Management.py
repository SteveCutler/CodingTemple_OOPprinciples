...
# focusing on the use of private attributes and getters and setters. Students will apply these 
# concepts to create a Personal Budget Management system.

# Problem Statement: You are required to build a Personal Budget Management application. The 
# application will manage budget categories like food, entertainment, utilities, etc., ensuring 
...
import BudgetCategory as BC

Entertainment = BC.BudgetCategory("entertainment", 500)

# print(Entertainment.__budget)
# print(Entertainment.__name)
...
budget = Entertainment.get_budget()
print(budget)
name = Entertainment.get_name()
print(name)
Entertainment.set_budget(300)
newbudget = Entertainment.get_budget()
print(newbudget)
Entertainment.set_name("Entertainment: movies")
newname = Entertainment.get_name()
print(newname)
...
Entertainment.deductExpense(50)
budget= Entertainment.get_budget()
print(budget)

#testing if statement
Entertainment.deductExpense(251)
